...
this.setState({ Data:responseJson.data})     
 ...
 _renderItem = ({ item, index }) => {
    ...
    if(item.thumb != null){
      ...
      image_url='https://screenshotlayer.com/images/assets/placeholder.png';
    }
    return (
     ...
     <ImageBackground source={{uri:image_url}} style={{width:100,height: 100,alignSelf: 'center',resizeMode: 'contain',}}>
        </ImageBackground>
