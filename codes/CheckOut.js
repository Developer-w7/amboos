    ...
    <View style={styles.loading}>
      <ActivityIndicator size='large' color="#0000ff" />
                ...
                <Collapse
                    ...
                    style={{  marginTop: 1}}>
                    <CollapseHeader style={styles.header_style}>
                        
                            <View style={styles.heading_wrap}>
                            <Icon style={{color: '#fff',marginLeft: 10}}  name="ios-home" size={22} />
                ...
                <Collapse style={{ marginTop: 1
                    ...
                    <CollapseHeader style={styles.header_style}>
                    <View style={styles.heading_wrap}>
                            <Icon style={{color: '#fff',marginLeft: 10}}  name="logo-dropbox" size={22} />
                ...
                <Collapse
                    ...
                    <CollapseHeader style={styles.header_style}>
                    <View style={styles.heading_wrap}>
                            <Icon style={{color: '#fff',marginLeft: 10}}  name="ios-swap" size={22} />
                ...
                <Collapse
                    ...
                    marginTop: 1
                     ...
                     <CollapseHeader style={styles.header_style}>
                     <View style={styles.heading_wrap}>
                            <Icon style={{color: '#fff',marginLeft: 10}}  name="ios-card" size={22} />
